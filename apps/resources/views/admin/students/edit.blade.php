            ...
            <form action="{{ route('students.update', $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card p-2 mb-3 border border-success">
                    <header class="card-header p-1">
                        <h3>Edit {{ $data->name }} Information</h3>
                    </header>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select name="role" class="form-control select2">
                                        <option value="student" @selected(($data->role ?? '') == 'student')>Student</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-8 ">
                                    <select name="class" class="form-control select2">
                                        @foreach ($classes as $class)
                                            <option value="{{ $class->name_en }}" @selected($class->name_en == $data->class) >{{ $class->name_en }}</option>
                                        @endforeach
