            ...
            <div class="card-body">
                <form action="{{ route('institutes.update',$data->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($data->id_card_front_employee) }}"
                            class="my-3"
                            width="200px"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($data->id_card_front_student) }}"
                            class="my-3"
                            width="200px"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($data->id_card_back) }}"
                            class="my-3"
                            width="200px"
                            id="id_card_back">
                        <input  type="file"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($data->exam_admit_card) }}"
                            class="my-3"
                            width="50%"
                            id="exam_admit_card">
                        <input  type="file"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($data->exam_seat_sticker) }}"
                            class="my-3"
                            width="200px"
