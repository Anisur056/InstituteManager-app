...
@section('page-title') Branches @endsection
            ...
            <div class="card-body">
                ...
                <tbody>
                    @foreach ($records as $data)
                        <tr>
                            <td data-label="Instititue Info ID: ">{{$data->institute_info_id}}</td>
                            <td data-label="Branch Name: ">{{$data->name_en}}</td>
                            <td data-label="শাখার নাম: ">{{$data->name_bn}}</td>
                            <td data-label="Display Order: " class="text-start">{{$data->display_order}}
                            <td class="d-flex">
                                <a href="{{ route('branches.edit',$data->id) }}" class="btn btn-success rounded-3 m-1">
