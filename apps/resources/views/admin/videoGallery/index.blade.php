            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <td class="">
                                <a href="{{ route('gallery.show',$data->id) }}" class="btn btn-success rounded-3 m-1 w-100">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('gallery.edit',$data->id) }}" class="btn btn-warning rounded-3 m-1 w-100">
