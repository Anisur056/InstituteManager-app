            ...
            <ul class="metismenu">
                ...
                <li class="">
                    ...
                    <ul class="nav-second-level ">
                        ...
                        <li class="">
                            <a class="dropdown-item" href="{{ route('attendance.sheet.employee') }}">Attendance Sheet</a>
                        </li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('attendance.sheet.student') }}">Attendance Sheet</a>
                        </li>
