...
class TblFingerDevice extends Controller
{
    ...
    public function getDeviceAttendanceLog()
    {
        ...
        if ($zk->connect()) {
            ...
            return view('admin.device.user')->with('message', 'The ZKTeco device is not available. Please check the device power, network connection, or IP and port settings');
            die();
        }
